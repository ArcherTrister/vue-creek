<template>
  <div @dragstart.prevent
       :class="[
      'vc-input-number',
      inputNumberSize ? 'vc-input-number--' + inputNumberSize : '',
      { 'is-disabled': inputNumberDisabled },
      { 'is-without-controls': !controls },
      { 'is-controls-right': controlsAtRight }
    ]">
    <span class="vc-input-number__decrease"
          role="button"
          v-if="controls"
          v-repeat-click="decrease"
          :class="{'is-disabled': minDisabled}"
          @keydown.enter="decrease">
      <i :class="`vc-icon-${controlsAtRight ? 'arrow-down' : 'minus'}`"></i>
    </span>
    <span class="vc-input-number__increase"
          role="button"
          v-if="controls"
          v-repeat-click="increase"
          :class="{'is-disabled': maxDisabled}"
          @keydown.enter="increase">
      <i :class="`vc-icon-${controlsAtRight ? 'arrow-up' : 'plus'}`"></i>
    </span>
    <vc-input ref="input"
              :value="displayValue"
