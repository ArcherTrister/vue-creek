  ...
  <div class="vc-time-spinner"
    ...
    <template v-if="!arrowControl">
      ...
      <vc-scrollbar @mouseenter.native="emitSelectRange('minutes')"
                    ...
                    tag="ul"
                    ref="minutes">
        <li @click="handleClick('minutes', { value: key, disabled: false })"
            v-for="(enabled, key) in minutesList"
            :key="key"
            class="vc-time-spinner__item"
            :class="{ 'active': key === minutes, disabled: !enabled }">{{ ('0' + key).slice(-2) }}</li>
      </vc-scrollbar>
      <vc-scrollbar v-show="showSeconds"
                    ...
                    tag="ul"
                    ref="seconds">
        <li @click="handleClick('seconds', { value: key, disabled: false })"
    ...
    <template v-if="arrowControl">
      <div @mouseenter="emitSelectRange('hours')"
           class="vc-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease"
           class="vc-time-spinner__arrow vc-icon-arrow-up"></i>
        <i v-repeat-click="increase"
           class="vc-time-spinner__arrow vc-icon-arrow-down"></i>
        <ul class="vc-time-spinner__list"
            ref="hours">
          <li class="vc-time-spinner__item"
      ...
      <div @mouseenter="emitSelectRange('seconds')"
           class="vc-time-spinner__wrapper is-arrow"
           v-if="showSeconds">
        <i v-repeat-click="decrease"
           class="vc-time-spinner__arrow vc-icon-arrow-up"></i>
        ...
        <ul class="vc-time-spinner__list"
            ref="seconds">
          <li v-for="(second, key) in arrowSecondList"
              class="vc-time-spinner__item"
