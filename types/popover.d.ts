...
import { VueCreekUIComponent } from './component'
...
export interface VcPopoverDirective extends VNodeDirective {
  name: 'popover',
  arg: string
}

/** Popover Component */
export declare class VcPopover extends VueCreekUIComponent {
