<template>
  <transition name="vc-zoom-in-top"
    ...
    <div v-show="visible"
         class="vc-picker-panel vc-date-picker vc-popper"
         :class="[{
      ...
      <div class="vc-picker-panel__body-wrapper">
        ...
        <div class="vc-picker-panel__body">
          <div class="vc-date-picker__time-header"
               v-if="showTime">
            <span class="vc-date-picker__editor-wrap">
              <vc-input :placeholder="t('el.datepicker.selectDate')"
                        :value="visibleDate"
                        size="small"
          ...
          <div class="vc-date-picker__header"
               :class="{ 'vc-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
               v-show="currentView !== 'time'">
            <button type="button"
                    @click="prevYear"
                    :aria-label="t(`el.datepicker.prevYear`)"
                    class="vc-picker-panel__icon-btn vc-date-picker__prev-btn vc-icon-d-arrow-left">
            </button>
            <button type="button"
                    @click="prevMonth"
                    v-show="currentView === 'date'"
                    :aria-label="t(`el.datepicker.prevMonth`)"
                    class="vc-picker-panel__icon-btn vc-date-picker__prev-btn vc-icon-arrow-left">
            </button>
            <span @click="showYearPicker"
                  role="button"
                  class="vc-date-picker__header-label">{{ yearLabel }}</span>
            <span @click="showMonthPicker"
                  v-show="currentView === 'date'"
                  role="button"
                  class="vc-date-picker__header-label"
                  :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button type="button"
                    @click="nextYear"
                    :aria-label="t(`el.datepicker.nextYear`)"
                    class="vc-picker-panel__icon-btn vc-date-picker__next-btn vc-icon-d-arrow-right">
            </button>
            <button type="button"
                    @click="nextMonth"
                    v-show="currentView === 'date'"
                    :aria-label="t(`el.datepicker.nextMonth`)"
                    class="vc-picker-panel__icon-btn vc-date-picker__next-btn vc-icon-arrow-right">
            </button>
          </div>

          <div class="vc-picker-panel__content">
...
export default {
  ...
  components: {
    TimePicker, YearTable, MonthTable, DateTable, VcInput, VcButton
  },
