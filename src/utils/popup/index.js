...
import PopupManager from 'vue-creek/src/utils/popup/popup-manager';
  ...
  methods: {
    ...
    doOpen(props) {
      ...
      if (modal) {
        ...
        if (props.lockScroll) {
          ...
          addClass(document.body, 'vc-popup-parent--hidden');
        }
      }
    ...
    restoreBodyStyle() {
      if (this.modal && this.withoutHiddenClass) {
        ...
        removeClass(document.body, 'vc-popup-parent--hidden');
      }
