<template>
  <div :class="videoContainer"
    ...
    <div class="__cov-video-container"
      ...
      <video :class="{ 'hide-cursor': !state.contrlShow }"
             class="__cov-video"
          ...
          <svg class="__cov-contrl-play-btn-icon"
            ...
            <g id="Page-1"
              ...
              <polygon id="Triangle-1"
                       stroke="#FFFFFF"
                       fill="#FFFFFF"
                       points="1 56 1 1 47 28.5"></polygon>
            </g>
          </svg>
          <svg class="__cov-contrl-play-btn-icon"
               v-show="state.playing"
            ...
            <desc>Created with Sketch.</desc>
            <defs>
              <path d="M0,0.979149244 L5,0.979149244 L5,22 L0,22 L0,0.979149244 Z M10,0.979149244 L15,0.979149244 L15,22 L10,22 L10,0.979149244 Z"
                    id="path-1"></path>
              <mask id="mask-2"
        ...
        <div class="__cov-contrl-vol-box">
          <button class="__cov-contrl-play-btn"
            ...
            <svg class="__cov-contrl-vol-btn-icon"
              ...
              <desc>Created with Sketch.</desc>
              <defs>
                <path d="M8.61522369,12 L20,0.615223689 L20,37.3847763 L8.61522369,26 L1.99201702,26 C0.891856397,26 0,25.1029399 0,23.9941413 L0,14.0058587 C0,12.8980535 0.900176167,12 1.99201702,12 L8.61522369,12 L8.61522369,12 Z"
                      id="cov-vol"></path>
              </defs>
              <g id="Page-1"
                 stroke="none"
          ...
          <div class="__cov-contrl-vol-slider"
               @click="volSlideClick"
               @mousedown="volMove">
        ...
        <button class="__cov-contrl-play-btn"
          ...
          <svg class="__cov-contrl-vol-btn-icon"
            ...
            <g id="Page-1"
               ...
               fill="none"
               fill-rule="evenodd">
              <path d="M31.1682064,22 L31.1682064,31.0073537 L22,31.0073537 M22,1 L31.0073537,1 L31.0073537,10.1682064 M1,10.0073537 L1,1 L10.1682064,1 M10.0073537,31.1682064 L1,31.1682064 L1,22"
                    id="Combined-Shape"
                    stroke="#FFFFFF"
                    stroke-width="2"></path>
            </g>
...
<script>
import flvjs from '../../../src/utils/flv.js';
