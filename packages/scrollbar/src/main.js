...
export default {
  ...
  render(h) {
    ...
    const view = h(
      this.tag,
      {
        class: ['vc-scrollbar__view', this.viewClass],
    ...
    const wrap = (
      <div
        ...
        class={[
          this.wrapClass,
          'vc-scrollbar__wrap',
          gutter ? '' : 'vc-scrollbar__wrap--hidden-default'
        ]}
      >
        {[view]}
      </div>
    ...
    if (!this.native) {
      ...
      nodes = [
        <div
          ref="wrap"
          class={[this.wrapClass, 'vc-scrollbar__wrap']}
          style={style}
        >
          {[view]}
        </div>
    ...
    return h('div', { class: 'vc-scrollbar' }, nodes);
  },
