<template>
  <transition name="vc-zoom-in-top"
    ...
    <div v-show="visible"
         class="vc-picker-panel vc-date-range-picker vc-popper"
         :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="vc-picker-panel__body-wrapper">
        <slot name="sidebar"
              class="vc-picker-panel__sidebar"></slot>
        <div class="vc-picker-panel__sidebar"
             v-if="shortcuts">
          <button type="button"
                  class="vc-picker-panel__shortcut"
                  v-for="(shortcut, key) in shortcuts"
                  :key="key"
                  @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="vc-picker-panel__body">
          <div class="vc-date-range-picker__time-header"
               v-if="showTime">
            <span class="vc-date-range-picker__editors-wrap">
              <span class="vc-date-range-picker__time-picker-wrap">
                <vc-input size="small"
                          :disabled="rangeState.selecting"
                          ref="minInput"
                          :placeholder="t('el.datepicker.startDate')"
                          class="vc-date-range-picker__editor"
            ...
            <span class="vc-icon-arrow-right"></span>
            <span class="vc-date-range-picker__editors-wrap is-right">
              <span class="vc-date-range-picker__time-picker-wrap">
                <vc-input size="small"
                          class="vc-date-range-picker__editor"
                          :disabled="rangeState.selecting"
          ...
          <div class="vc-picker-panel__content vc-date-range-picker__content is-left">
            <div class="vc-date-range-picker__header">
              <button type="button"
                      @click="leftPrevYear"
                      class="vc-picker-panel__icon-btn vc-icon-d-arrow-left"></button>
              <button type="button"
                      @click="leftPrevMonth"
                      class="vc-picker-panel__icon-btn vc-icon-arrow-left"></button>
              <button type="button"
                      @click="leftNextYear"
                      v-if="unlinkPanels"
                      :disabled="!enableYearArrow"
                      :class="{ 'is-disabled': !enableYearArrow }"
                      class="vc-picker-panel__icon-btn vc-icon-d-arrow-right"></button>
              <button type="button"
                      @click="leftNextMonth"
                      v-if="unlinkPanels"
                      :disabled="!enableMonthArrow"
                      :class="{ 'is-disabled': !enableMonthArrow }"
                      class="vc-picker-panel__icon-btn vc-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
          ...
          <div class="vc-picker-panel__content vc-date-range-picker__content is-right">
            <div class="vc-date-range-picker__header">
              <button type="button"
                      @click="rightPrevYear"
                      v-if="unlinkPanels"
      ...
      <div class="vc-picker-panel__footer"
           v-if="showTime">
        <vc-button size="mini"
                   type="text"
                   class="vc-picker-panel__link-btn"
                   @click="handleClear">
...
import VcButton from 'vue-creek/packages/button';
...
export default {
  ...
  components: { TimePicker, DateTable, VcInput, VcButton }
};
</script>
