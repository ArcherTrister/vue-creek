<template>
  <div class="vc-time-spinner" :class="{ 'has-seconds': showSeconds }">
    ...
    <template v-if="arrowControl">
      <div
        ...
        <i v-repeat-click="decrease" class="vc-time-spinner__arrow vc-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="vc-time-spinner__arrow vc-icon-arrow-down"></i>
        <ul class="vc-time-spinner__list" ref="hours">
          <li
            class="vc-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="vc-time-spinner__arrow vc-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="vc-time-spinner__arrow vc-icon-arrow-down"></i>
        <ul class="vc-time-spinner__list" ref="minutes">
          <li
            class="vc-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="vc-time-spinner__arrow vc-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="vc-time-spinner__arrow vc-icon-arrow-down"></i>
        <ul class="vc-time-spinner__list" ref="seconds">
          <li
